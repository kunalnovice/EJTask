...
public class CallingCodeAPI extends Common {



    public void executeCallingCodeGET(int arg0) throws Exception {
        RequestSpecification reqSpec = reqHelper.getRequestSpec();
        String callingCodeAPI= testEnvironmentObject.getPropertyValue("callingCode")+arg0;
